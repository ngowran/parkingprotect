...
const features = [
    {
        name: 'Instagram',
        link:
            'https://www.instagram.com/parkingprotect/',
        icon: FaInstagram,
    },
    {
        name: 'Email',
        link:
            'mailto:info@parking-protect.com',
        icon: TfiEmail,
    },
    {
        name: 'Linkedin',
        link:
            'https://www.linkedin.com/enactusdcu/',
        icon: BsLinkedin,
    },
]
        ...
        <div id="contact" className="p-6">
            <div className="mx-auto text-center max-w-2xl px-2 pt-16">
                ...
                <p className="mt-4 text-xl font-medium">
                    We are always looking for new ways to improve our service. If you have any questions or suggestions, please get in touch!
                </p>
            </div>
                                ...
                                <motion.div
                                    ...
                                    <dt>
                                        <a href={feature.link} target="blank">
                                            <div className="absolute flex h-12 w-12 items-center justify-center rounded-md dark-blue text-white">
